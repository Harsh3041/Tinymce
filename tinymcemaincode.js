...
!(function () {
  ...
  function Qd(q, $) {
    ...
    void 0 === $ && ($ = ro());
    var W =
        null !== (e = (q = q || {}).document) && void 0 !== e ? e : document,
  ...
  function bm(e, t) {
    return [e].concat(vm(e, t));
  }
  function ym(e, t, n) {
    return Zl(e, t, n, fm);
  }
  function Cm(e, t) {
    return M(bm(kt.fromDom(t.container()), e), mo);
  }
  function xm(e, n, r) {
    return ym(e, n.dom, r).forall(function (t) {
      return Cm(n, r).fold(
        function () {
  ...
  function wm(t, n, r) {
    return Cm(n, r).fold(
      function () {
        return ym(t, n.dom, r).forall(function (e) {
          return !1 === Js(e, r, n.dom);
        });
      },
      function (e) {
        return ym(t, e.dom, r).isNone();
      }
    );
  }
  function Sm(e) {
  ...
  function Em(e, t, n) {
    var r = Q(U(bm(kt.fromDom(n.container()), t), mo)).getOr(t);
    return Ql(e, r.dom, n).filter(Sm);
  }
  function km(e, t) {
    return oc(t).exists(Br) || Em(!0, e, t).isSome();
  }
  function Nm(e, t) {
    return (
      ve.from(t.getNode(!0)).map(kt.fromDom).exists(Br) || Em(!1, e, t).isSome()
    );
  }
  function _m(e) {
  ...
  function Am(e, t) {
    return Q(U(bm(kt.fromDom(t.container()), e), mo)).getOr(e);
  }
  function Rm(e, t) {
    return _m(t) ? Yg(t) : Yg(t) || tf(Am(e, t).dom, t).exists(Yg);
  }
  function Dm(e, t) {
    return _m(t) ? Xg(t) : Xg(t) || ef(Am(e, t).dom, t).exists(Xg);
  }
  function Tm(e) {
    return oc(e)
      .bind(function (e) {
  ...
  function Om(e, t) {
    return !Tm(t) && (op(e, t) || ap(e, t) || Nm(e, t) || Rm(e, t));
  }
  function Bm(e, t) {
    return !Tm(t) && (ip(e, t) || up(e, t) || km(e, t) || Dm(e, t));
  }
  function Pm(e, t) {
    return (
      Om(e, t) ||
  ...
  function Fm(t) {
    ...
    t.selection.isCollapsed() &&
      Mm(e, ss.fromRangeStart(t.selection.getRng())).each(function (e) {
  ...
  function Um(e, t, n) {
    ...
    0 !== n &&
      ...
      (a = t + n >= e.data.length && Bm(o, ss(e, e.data.length))),
      (u = 0 === t && Om(o, ss(e, 0))),
      e.replaceData(
        t,
        n,
      ...
      C =
        ...
        (d = function (e, t, n) {
          var r = e.dom,
            o = t.dom,
            i = r.data.length;
          return jm(r, o, s), n.container() === o ? ss(r, i) : n;
        }),
  ...
  function rg(e) {
    return function (t) {
      return ng(t, e).map(function (e) {
        return { rng: t, table: e, cells: Qm(e) };
      });
    };
  }
  function og(e, t, n, r) {
    if (n.collapsed || !e.forall(tg)) return ve.none();
    if (t.isSameTable) {
      var o = e.bind(rg(r));
    ...
    var i,
      a,
      u = eg(n.startContainer, r),
      s = eg(n.endContainer, r),
      c = u
        .bind(
          ((a = r),
          function (t) {
            return Dl(t, a).bind(function (e) {
              return Z(Qm(e)).map(function (e) {
                return Zm(t, e);
              });
            });
          })
  ...
  function ag(n) {
    return dn(
      ig(n.cells, n.rng.start),
      ig(n.cells, n.rng.end),
      function (e, t) {
  ...
  function sg(e, t) {
    var n,
      ...
      y = dn(eg((r = t).startContainer, (o = b)), eg(r.endContainer, o), Zm),
      C =
        ((l = b),
    ...
    return (
      ...
      y.exists(function (e) {
        ...
        ? y.map(function (e) {
            return lp.singleCellTable(t, e.start);
          })
        : C.isMultiTable
        ? og(y, (u = C), (s = t), b).bind(function (e) {
            var t = e.start,
              n = e.end,
              r = t.bind(ag).getOr([]),
              o = n.bind(ag).getOr([]);
            if (0 < r.length && 0 < o.length) {
              var i = ug(s, u);
              return ve.some(lp.multiTable(r, o, i));
            }
            return ve.none();
          })
        : og(y, (i = C), (a = t), b)
            ...
            .bind(function (e) {
              ...
              if (t && e.cells.length === n.length)
                return ve.some(lp.fullTable(e.table));
              if (0 < n.length) {
                if (t) return ve.some(lp.partialTable(n, ve.none()));
                var r = ug(a, i);
                return ve.some(
                  lp.partialTable(n, ve.some(_e(_e({}, i), { rng: r })))
                );
              }
              return ve.none();
            })
          ...
          .bind(function (e) {
            ...
            o.deleteContents(),
              ...
              a.filter(Wr).each(function (e) {
                r ? Ln(e) : (pm(e), n.selection.setCursorLocation(e.dom, 0));
              });
  ...
  function mg(e, t, n, r) {
    var o = e.selection.getRng(),
      i = t[0],
      a = n[n.length - 1];
    lg(e, i, o, !0), lg(e, a, o, !1);
    var u = Wr(i) ? t : t.slice(1),
      s = Wr(a) ? n : n.slice(0, -1);
    return cg(u.concat(s)), r.deleteContents(), fg(e), !0;
  }
  function gg(e, t) {
    return Jm(e, !1, t), !0;
  }
              ...
              return Wr(e)
                ...
                : ((t = a),
                  ...
                  zc(i, o.getBody(), r).bind(function (e) {
                    return pg(t, kt.fromDom(e.getNode())).map(function (e) {
                      return !1 === je(e, n);
                    });
                  }));
              var t, n, r;
                ...
                .bind(function (e) {
                  return (
                    ...
                    nf((n = c).dom)
                      ...
                      ? gp(a, c)
                      : ((t = c),
                        mp(u, kt.fromDom(e.getNode())).map(function (e) {
                          return !1 === je(e, t);
                        }))
                  );
                  var t, n, r, o, i;
            ...
            mp((s = i), r)
              .fold(
                function () {
                  return (
                    (t = u),
                    sg(s, c).map(function (e) {
                      return e.fold(R(dp, t), R(gg, t), R(dg, t), R(mg, t));
                    })
                  );
                  var t;
                },
  ...
  function Eg(e, o, i, t) {
    ...
    return n(1)
      ...
      : n(2)
      ? ((l = R), (d = T), o.insertAfter((f = D).reverse(), l), Sg(f[0], d))
      : ((g = D),
        (p = T),
        (h = m = R),
        (b = (v = i).cloneRange()),
  ...
  function kg(e, t, n) {
    ...
    /^ | $/.test(t) &&
      ...
      (o = u.getRng()),
      (i = t),
      (i = Om((a = kt.fromDom(r.getRoot())), ss.fromRangeStart(o))
        ? i.replace(/^ /, "&nbsp;")
        : i.replace(/^&nbsp;/, " ")),
      (t = i =
        Bm(a, ss.fromRangeEnd(o))
          ? i.replace(/(&nbsp;| )(<br( \/)>)?$/, "&nbsp;")
          : i.replace(/&nbsp;(<br( \/)?>)?$/, " ")));
    var c = e.parser,
      l = n.merge,
      f = om({ validate: e.getParam("validate") }, e.schema),
    ...
    if (m.isDefaultPrevented())
      ...
      h === v &&
        ...
        u.isCollapsed() ||
          (function (e) {
            ...
            var r,
              o = t.getParent(n.startContainer, pp),
              i = n;
            null !== (r = o) &&
            r === t.getParent(i.endContainer, pp) &&
            Tl(kt.fromDom(r), i)
              ? dp(e, n, kt.fromDom(o))
      ...
      var b,
        ...
        B = c.parse(t, O);
      if (!0 === n.paste && Cg(e.schema, B) && wg(s, I))
        return (
          (g = Eg(f, s, u.getRng(), B)),
          u.setRng(g),
      ...
      (E = l),
              ...
              for (
                ...
                !(function (r, o, i) {
                  ...
                  return F(e, function (t) {
                    ...
                    if (e(u) || !e(Kg)) return a(t);
                    var n = U(u, function (t) {
                      return F(Kg, function (e) {
                        return Ge(t, e);
                      });
                    });
                    return F(n, a);
        ...
        (D = s),
        (T = u.getStart()),
        ve.from(D.getParent(T, "td,th")).map(kt.fromDom).each(hm),
        e.fire("SetContent", m),
        e.addVisual();
    }
  }
  ...
  function Ag(u, s, e) {
    var t,
      n =
        ((t = s),
        _e(_e({ format: "html" }, e), { set: !0, content: Ng(t) ? "" : t })),
      ...
      ve.from(u.getBody()).fold(J(s), function (e) {
        return Ng(s)
          ? (function (e, t, n, r) {
              ...
              var s = om({ validate: e.validate }, e.schema).serialize(n);
              return (
                (r.content = yo(kt.fromDom(t)) ? s : Et.trim(s)),
                _g(e, r.content, r.no_selection),
          ...
          : ((t = u),
            ...
            0 === (r = s).length || /^\s+$/.test(r)
              ? ((i = '<br data-mce-bogus="1">'),
                ...
                _g(t, r, o.no_selection),
                t.fire("SetContent", o))
              : ("raw" !== o.format &&
                  (r = om({ validate: t.validate }, t.schema).serialize(
                    t.parser.parse(r, { isRootContent: !0, insert: !0 })
                  )),
                (o.content = yo(kt.fromDom(n)) ? r : Et.trim(r)),
                _g(t, o.content, o.no_selection),
  ...
  function Dg(i, e, t) {
    ...
    return n.orThunk(function () {
      return a(i)
        ? ve.none()
        : (function (e) {
            for (var t = i.dom, n = Rg(a); t.parentNode; ) {
              var t = t.parentNode,
                r = kt.fromDom(t),
                o = e(r);
  ...
  function Og(t, e, n, r, o) {
    ...
    return (
      ...
      ((e = t.dom.getParent(e, function (e) {
        return !!Tg(t, e, n) || e.parentNode === i || !!bp(t, e, n, r, !0);
      })),
      !!bp(t, e, n, r, o))
    );
  }
        ...
        for (var u in a)
          if (ke(a, u)) {
            ...
            if (!l || !K(c)) {
              ...
              if ((!o || n.exact) && !vp(s, ul(e, c, u))) return;
            }
          }
      } else
  ...
  function Lg(e, t, n, r, o) {
    if (r) return Og(e, r, t, n, o);
    if (((r = e.selection.getNode()), Og(e, r, t, n, o))) return !0;
    var i = e.selection.getStart();
    return !(i === r || !Og(e, i, t, n, o));
  }
  function Ig(e) {
    return (
      0 <
  ...
  function Fg(e) {
    ...
    return (
      hn(t, { id: Cp, "data-mce-bogus": "1", "data-mce-type": "format-caret" }),
      e && Pn(t, kt.fromText(yp)),
      t
    );
  }
  function Ug(e, t, n) {
    ...
    Ig(t)
      ...
      : ((r = d.getRng()),
        ...
        (u = r.endContainer),
        (s = r.endOffset),
        (l = Mg(t)) && l.nodeValue.charAt(0) === yp && l.deleteData(0, 1),
        (c = l),
        f.remove(t, !0),
        i === c && 0 < a && r.setStart(c, a - 1),
        u === c && 0 < s && r.setEnd(c, s - 1),
        o && f.isEmpty(o) && pm(kt.fromDom(o)),
        d.setRng(r));
  }
  function zg(e, t, n) {
    void 0 === n && (n = !0);
  ...
  function jg(e, t) {
    var n = P(
      e,
      function (e, t) {
        return Hg(e, t.cloneNode(!1));
      },
      t
    );
    return Hg(n, n.ownerDocument.createTextNode(yp));
  }
  function Vg(o, e, t, i, n, r) {
    var a,
      u,
      s = o.formatter,
      c = o.dom,
  ...
  var Wg,
    Kg = ["font", "text-decoration", "text-emphasis"],
    Xg = R(lm, !0, Qc),
    Yg = R(lm, !1, Qc),
    Gg = dm(!0, mm),
    Jg = dm(!1, mm),
    ...
    dp = function (e, t, n, r) {
      ...
      return (
        Wr(a) && (pm(a), r && e.selection.setCursorLocation(a.dom, 0)),
        je(n, a) ||
          Y(
            (fn(Ot(a), n)
              ? []
    ...
    mp = function (e, t) {
      return M(bm(t, e), function (e) {
        return Nn(e) && "caption" === Nt(e);
      });
    },
    gp = function (e, t) {
      return pm(t), e.selection.setCursorLocation(t.dom, 0), ve.some(!0);
    },
    pp = Gn,
    hp = function (e, t) {
      t(e), e.firstChild && hp(e.firstChild, t), e.next && hp(e.next, t);
    },
    vp = al,
  ...
  function Ip(e, r, o, t, i) {
    ...
    if ("all" !== r.remove) {
      _h(r.styles, function (e, t) {
        (e = ul(u, il(e, o), t + "")),
          E(t) && ((t = e), (i = null)),
          (!r.remove_similar && i && !Ah(sl(u, i, t), e)) ||
            u.setStyle(b, t, ""),
          (n = !0);
      }),
        n &&
        ...
        _h(r.attributes, function (e, t) {
          var n;
          if (
            ((e = il(e, o)),
            E(t) && ((t = e), (i = null)),
            r.remove_similar || !i || Ah(u.getAttrib(i, t), e))
          )
            if (
              "class" === t &&
              (e = u.getAttrib(b, t)) &&
              ...
              if (
                (Nh.test(t) && b.removeAttribute("data-mce-" + t),
                "style" === t &&
                  on(["li"])(b) &&
    ...
    return "none" !== r.remove
      ? ((l = e),
        ...
        dl(d) &&
          (v
            ? p === h.getRoot() &&
              ((d.list_block && Ah(f, d.list_block)) ||
            ...
            : h.isBlock(f) &&
              !h.isBlock(p) &&
              (Lp(h, f, !1) ||
                Lp(h, f.firstChild, !0, !0) ||
                f.insertBefore(h.create("br"), f.firstChild),
              Lp(h, f, !0) ||
                Lp(h, f.lastChild, !1, !0) ||
                f.appendChild(h.create("br")))),
        (ml((g = d)) && gl(g) && fn(ue(g, "mixed"), !0) && !Ah(d.inline, f)) ||
          h.remove(f, !0),
        kh.removed())
      : kh.keep();
  }
  function Mp(t, e, n, r, o) {
    return Ip(t, e, n, r, o).fold(
      D,
      function (e) {
  ...
  function Fp(u, s, c, e, l) {
    ...
    function t(e) {
      ...
      if (g.split) {
        if (((t = Bf(t)), (r = Tp(u, t, !0)) !== (o = Tp(u, t)))) {
          if (((r = Op(r, !0)), (o = Op(o, !1)), Dp(h, r, o))) {
          ...
          var r = Bp(h, r, "span", {
            ...
            o = Bp(h, o, "span", { id: "_end", "data-mce-type": "bookmark" }),
            i = h.createRng();
          i.setStartAfter(r),
            i.setEndBefore(o),
            Nl(h, i, function (e) {
    ...
    if ("false" !== h.getContentEditable(r.getNode()))
      r.isCollapsed() && gl(g) && !Rl(u).length
        ...
        : (Ll(r, !0, function () {
          ...
          gl(g) && Lg(u, s, c, r.getStart()) && tl(h, r, r.getRng()),
          u.nodeChanged()),
        xf(u, s, e, c);
    else {
      e = r.getNode();
      for (
        var o = 0;
        o < m.length && (!m[o].ceFalseOverride || !Mp(u, m[o], c, e, e));
        o++
      );
      xf(u, s, e, c);
    }
  ...
  function Hp(n, e, r, o, i) {
    return I(
      ...
      function (e) {
        return Tg(n, e, r) || (!o && V(n.formatter.matchNode(e, r, i, !0)));
      }
    );
  }
  function jp(e, t) {
    ...
    return (
      Y(bu(e, "tr"), function (n, r) {
        Y(bu(n, "td,th"), function (e, t) {
          !(function (e, t, n, r, o) {
            for (
              var i = Kp(o, "rowspan"), a = Kp(o, "colspan"), u = e.rows, s = n;
              s < n + i;
              s++
            ) {
              u[s] || (u[s] = Wp(ku(r), []));
    ...
    return hr(i[0], "table", R(je, e))
      .bind(function (e) {
        ...
        return (
          ...
          Yp((s = o), n)
            .bind(function (u) {
              return Yp(s, t).map(function (e) {
                return (
                  (t = s),
                  (n = u.x),
                  (r = u.y),
                  (o = e.x),
                  (a = r < (i = e.y) ? Gp(t, n, r, o, i) : Gp(t, n, i, o, r)),
                  $p(t.element, Xp(a), a)
                );
                var t, n, r, o, i, a;
              });
  ...
  function ah(n) {
    var e,
      t = H(
        ((e = n.getBody()),
        U(A(xe(e.childNodes), oh), function (e) {
          return 0 < e.length;
        })),
        function (e) {
          var t = tm(n.serializer, e);
          return 0 < t.length ? [t] : [];
        }
      ),
      r = t.join("");
  ...
  function ch(e) {
    var t = kt.fromTag("body", Ph());
    return wu(t, sh(e)), Y(bu(t, "*[data-mce-bogus]"), Yt), t.dom.innerHTML;
  }
  function lh(e, t) {
    return (
      !(!e || !t) && ((r = t), sh(e) === sh(r) || ((n = t), ch(e) === ch(n)))
    );
    var n, r;
  }
  function fh(e) {
    ...
    return {
      undoManager: {
        beforeChange: function (e, t) {
          var n = c,
            r = t;
          fh(e) && r.set(pc(n.selection));
        },
        add: function (e, t, n, r, o, i) {
          return (function (e, t, n, r, o, i, a) {
            var u = ah(e);
            if (((i = Et.extend((i = i || {}), u)), !1 === fh(r) || e.removed))
              return null;
            var s = t.data[n.get()];
            if (
              e
        ...
        undo: function (e, t, n) {
          return (
            ...
            (i = t),
            (a = n),
            (o = e).typing && (o.add(), (o.typing = !1), dh(o, !1, i)),
            0 < a.get() &&
              (a.set(a.get() - 1),
              uh(r, (u = o.data[a.get()]), !0),
              r.setDirty(!0),
              r.fire("Undo", { level: u })),
            u
          );
        ...
        hasUndo: function (e, t) {
          return (
            (n = c),
            (r = e),
            0 < t.get() || (r.typing && r.data[0] && !lh(ah(n), r.data[0]))
          );
          var n, r;
        },
        ...
        transact: function (e, t, n) {
          return (
            (o = n), mh((r = e), t), r.beforeChange(), r.ignore(o), r.add()
          );
          var r, o;
        },
        ignore: function (e, t) {
      ...
      formatter: {
                ...
                return Dg(
                  ...
                  function (n) {
                    return ee(o, function (e) {
                      return bp(r, n.dom, (t = e)) ? ve.some(t) : ve.none();
                      var t;
                    });
                  },
                  t
        ...
        toggle: function (e, t, n) {
          ...
          (!Lg(r, o, i, a) || ("toggle" in u[0] && !u[0].toggle) ? Th : Fp)(
            r,
            o,
            i,
            a
              ...
              .fold(
                ...
                function (e) {
                  return (
                    ...
                    (f =
                      "raw" === l.format
                        ? Et.trim(im(t.serializer, r.innerHTML))
                        : "text" === l.format
                        ? t.dom.isEmpty(r)
                          ? ""
                ...
                ve
                  ...
                  .map(function (e) {
                    var t = ve.from(
                      ...
                      a = rh(i, o),
                      u = Eo(i.textContent);
                    if ((m.dom.remove(i), nh(u, 0) || nh(u, u.length - 1))) {
                      var s = rh(t.getOr(n), o),
                        c = s.indexOf(a);
                      return -1 === c
                        ? a
                        : (nh(s, c - 1) ? " " : "") +
  ...
  function hh(e) {
    ...
    return ue(e.plugins, "rtc")
      ...
      .fold(
        function () {
          return (u.rtcInstance = gh(e)), ve.none();
        },
        function (e) {
          var t, n;
          return (
  ...
  function Ch(e, t, u, s) {
    e.bind(function (a) {
      return (
        (s ? Hm : zm)(a.dom, s ? a.dom.length : 0),
        t.filter(_n).map(function (e) {
          var t = u,
            ...
            i = (n ? r : o).length;
          n
            ? (jm(r, o, !1, !n), t.setStart(o, i))
            : (jm(o, r, !1, !n), t.setEnd(o, i));
        })
      );
    }).orThunk(function () {
      var e = s;
      return t
        ...
        .map(function (e) {
          ...
          Ot((n = e)).each(function (e) {
            ...
            r && Om(e, ss(t, 0))
              ? zm(t, 0)
              : !r && Bm(e, ss(t, t.length)) && Hm(t, t.length);
          });
        });
    });
  }
  function xh(e, t, n) {
    ...
    i.content = (function (e, t) {
      ...
      return om({ validate: e.validate }, e.schema).serialize(i);
    })(e, i);
    ...
    !(function (e, t) {
      ...
      var o = n.bind(Bt).filter(_n).bind(yh),
        i = r.bind(Pt).filter(_n).bind(yh);
      Ch(o, n, e, !0), Ch(i, r, e, !1), e.collapse(!1);
  ...
  var Sh = Et.each,
    Eh = function (e, t, n) {
      Sh(e.childNodes, function (e) {
        Ep(e) && (t(e) && n(e), e.hasChildNodes() && Eh(e, t, n));
      });
    },
    kh = or([{ keep: [] }, { rename: ["name"] }, { removed: [] }]),
    Nh = /^(src|href|style)$/,
    _h = Et.each,
    Ah = al,
    Rh = Et.each,
    ...
    Th = function (S, E, k, r) {
      function N(n, e) {
        ...
        y((e = void 0 === e ? A : e).onformat) && e.onformat(n, e, k, r),
          Dh(e.styles, function (e, t) {
            u.setStyle(n, t, il(e, k));
          }),
          !e.styles ||
            ((t = u.getAttrib(n, "style")) &&
              u.setAttrib(n, "data-mce-style", t)),
          Dh(e.attributes, function (e, t) {
            u.setAttrib(n, t, il(e, k));
          }),
          Dh(e.classes, function (e) {
        ...
        Nl(x, e, function (e) {
          var s,
            c = function (e) {
              ...
              if (dl(A) && A.wrapper && bp(S, e, E, k)) s = null;
              else {
            ...
            (!(1 < w.length) && x.isBlock(e)) || 0 !== y
              ? (gl(A) || (dl(A) && A.wrapper)) &&
                ...
                Rh(_, function (t) {
                  var r, e, n;
                  gl(t) &&
                    Rh(h.dom.select(t.inline, b), function (e) {
                      Ep(e) && Mp(h, t, v, e, t.exact ? e : null);
                    }),
                    (r = h.dom),
                    (e = t).clear_child_styles &&
                      ((n = e.links ? "*:not(a)" : "*"),
                      Sh(r.select(n, b), function (n) {
                        Ep(n) &&
                          Sh(e.styles, function (e, t) {
                            r.setStyle(n, t, "");
                          });
                      }));
                }),
                (s = A),
                (bp((u = S), (f = e).parentNode, (c = E), (l = k)) &&
                  Mp(u, s, l, f)) ||
                  (s.merge_with_parents &&
                    u.dom.getParent(f.parentNode, function (e) {
                      if (bp(u, e, c, l)) return Mp(u, s, l, f), !0;
                    })),
                (a = e),
                (i = A).styles &&
                  ...
                  Eh(
                    a,
                    Ap(x, "fontSize"),
                    Rp(x, "backgroundColor", il(i.styles.backgroundColor, k))
                  ),
                (m = x),
                (p = e),
                (g = A).styles &&
                ...
                !gl((r = A)) ||
                  ...
                  (Eh(o, Ap(t, "fontSize"), Rp(t, "fontSize", "")),
                  t.remove(
    ...
    Bh = function (i, a, e) {
      ...
      ne(e, function (e, o) {
        function t(e) {
          var t,
            n = Hp(i, u, o, e.similar, zp(e) ? e.vars : void 0),
            r = n.isSome();
          e.state.get() !== r &&
            (e.state.set(r),
            (t = n.getOr(a)),
  ...
  function Mh(a, u, e, s) {
    ...
    var l,
      ...
      h = function (e, t) {
        ...
        if (
          (r = e) &&
          (Lh(r) || (Ih(r.startContainer) && Ih(r.endContainer)))
        ) {
          var r,
            o = Lh(e) ? e : null;
          if (o) {
  ...
  function Hh(e) {
    return 0 === e.indexOf("blob:")
      ...
      ? ((n = e),
        new Nr(function (e) {
          var t = Uh(n);
          zh(t.type, t.data).fold(function () {
            return e(new Blob([]));
          }, e);
        }))
      : null;
        ...
        ((n = /data:([^;]+);base64,([a-z0-9\+\/=\s]+)/i.exec(r))
          ...
          .bind(function (e) {
            ...
            return ve.from(i.getByData(n, t)).orThunk(function () {
              return zh(t, n).map(function (e) {
                var t = i.create(jh(), e, n);
                return i.add(t), t;
              });
            });
          })
          ...
          if (
            ...
            o &&
              ...
              $h(h, m, g, i) &&
                ...
                (c.removeEmpty ? i.remove() : c.paddEmpty && qh(p, n, d, i)));
          } else {
            for (
              a = o;
  ...
  function Kh(A, R) {
    ...
    var e = {
      ...
      parse: function (e, s) {
        ...
        var g = vv(
            gv("script,style,head,html,body,title,meta,param"),
            R.getBlockElements()
          ),
          p = to(R),
          ...
          N = Qd(
            {
              ...
              start: function (e, t, n) {
                ...
                if (i) {
                  ...
                  (function () {
                    for (var e = l; V(e); ) {
                      if (e.name in p) return $h(R, h, C, e);
                      e = e.parent;
                    }
                  })()
                    ? qh(A, s, g, l)
                    ...
                    ? g[l.name]
                      ...
                      : l.unwrap()
                    : i.paddEmpty &&
                      ((mv((o = l), "#text") && o.firstChild.value === xo) ||
                        a) &&
                      qh(A, s, g, l),
                    (l = u);
                }
        ...
        if (
          ...
          b &&
            ...
            (s.context
              ...
              : (function (e) {
                  for (
                    var t = gv("tr,td,th,tbody,thead,tfoot,table"),
    ...
    return Wh(e, A), A.inline_styles && Fh(e, A), e;
  }
  function Xh(e, t, n) {
    -1 === Et.inArray(t, n) &&
  ...
  function Jh(e, t, n) {
    return (r = n = void 0 === n ? {} : n), vh(e).editor.setContent(t, r);
    var r;
  }
  function Qh(e) {
  ...
  function rv(e, t, n, r) {
    var o,
      ...
      l,
      f,
      d = ev(n.forced_plugins),
      m = ev(r.plugins),
      g = tv((o = t), "mobile") ? o.sections().mobile : {},
      p = g.plugins ? ev(g.plugins) : m,
      h =
        ((i =
          ((u = t),
          (s = m),
          ...
          (0,
          (f = (l = u).sections()),
          tv(l, "mobile") && "mobile" === f.mobile.theme)
            ? U(c, R(T, _v))
            : a && tv(u, "mobile")
            ? c
            : s)),
        [].concat(ev(d)).concat(ev(i)));
      ...
      m = e
        ? {
            mobile:
              ...
              (a = {
                resize: !1,
                toolbar_mode: nv(o.mobile || {}, "scrolling"),
                toolbar_sticky: !1,
              }),
              _e(_e(_e({}, Av), a), i ? { menubar: !1 } : {})),
          }
        : {},
      g =
        ((c = ["mobile"]),
  ...
  function sv(e, t, n) {
    var r,
      ...
      f =
        ...
        {
          x: i - (r ? u.left + o.dom.clientLeft + Bv(o) : 0),
          y: a - (r ? u.top + o.dom.clientTop + Ov(o) : 0),
        }),
      d = f.x,
      m = f.y,
      g = Dv((s = l)),
  ...
  var lv,
    ...
    yv =
      ...
      function () {
        ...
        for (var n = {}, r = 0; r < e.length; r++) {
          var o,
            i = e[r];
          for (o in i) ke(i, o) && (n[o] = lv(n[o], i[o]));
        }
        return n;
      }),
    Cv =
    ...
    wv = "imagetools,toc".split(","),
    Sv = dt().deviceType,
    Ev = Sv.isTouch(),
    kv = Sv.isPhone(),
    Nv = Sv.isTablet(),
    _v = ["lists", "autolink", "autosave"],
    Av = { table_grid: !1, object_resizing: !1, resize: !1 },
    Rv =
      ((fv = {}),
      {
        add: function (e, t) {
  ...
  function Hv(e, t, n) {
    Uv(e, "PluginLoadError", zv("plugin", t, n));
  }
  function jv(e) {
    var t, n;
  ...
  function qv(e) {
    return (
      e + dy++ + ("s" + new Date().getTime().toString(36) + t() + t() + t())
    );
    function t() {
  ...
  function Yv(l) {
    ...
    var u,
      ...
      v = function () {
        return (s = s || Vh(g, m)).findAll(l.getBody(), i).then(
          t(function (e) {
            return (
              (e = U(e, function (e) {
                return "string" != typeof e || void Fv(l, e);
              })),
              ph(l) ||
                Y(e, function (e) {
  ...
  function Gv(e, t) {
    function m(e) {
      ...
      var t,
        ...
        r = n;
      return (
        (t = o).classes.length && gy.addClass(r, t.classes.join(" ")),
        gy.setAttribs(r, t.attrs),
        n
      );
    }
    var n,
      ...
      p = function (n, e, t) {
        ...
        return (
          ...
          t &&
            (r || (r = gy.create("div")).appendChild(n),
    ...
    return e && e.length
      ? ((n = m((o = e[0]))),
        (r = gy.create("div")).appendChild(p(n, e.slice(1), o.siblings)),
        r)
      : "";
  }
  function Jv(e) {
        ...
        (s = e.selector) && "string" == typeof s
          ? ((s = (s = s.split(/\s*,\s*/)[0]).replace(
            ...
            Et.map(s.split(/(?:>|\s+(?![^\[\]]+\]))/), function (e) {
              var t = Et.map(e.split(/(?:~\+|~|\+)/), Jv),
                n = t.pop();
              return t.length && (n.siblings = t), n;
            }).reverse())
          : [],
      f = l.length
        ? (l[0].name || (l[0].name = c), (c = e.selector), Gv(l, n))
        : Gv([c], n),
      d = gy.select(c, f)[0] || f.firstChild;
    return (
      my(e.styles, function (e, t) {
        var n = a(e);
        n && gy.setStyle(d, t, n);
      }),
      my(e.attributes, function (e, t) {
        var n = a(e);
        n && gy.setAttrib(d, t, n);
      }),
      my(e.classes, function (e) {
        var t = a(e);
        gy.hasClass(d, t) || gy.addClass(d, t);
      }),
      n.fire("PreviewFormats"),
      gy.setStyles(f, { position: "absolute", left: -65535 }),
      n.getBody().appendChild(f),
      (r = gy.getStyle(n.getBody(), "fontSize", !0)),
      (r = /px$/.test(r) ? parseInt(r, 10) : 0),
      my(i.split(" "), function (e) {
        var t = gy.getStyle(d, e, !0);
        if (
          !(
            ("background-color" === e &&
              /transparent|rgba\s*\([^)]+,\s*0\)/.test(t) &&
              ((t = gy.getStyle(n.getBody(), e, !0)),
              "#ffffff" === gy.toHex(t).toLowerCase())) ||
            ("color" === e && "#000000" === gy.toHex(t).toLowerCase())
          )
        ) {
    ...
    return (
      ...
      (i = c).on("mouseup keydown", function (e) {
        ...
        zg(t, null, !1),
          (8 !== n && 46 !== n) ||
            !r.isCollapsed() ||
            r.getStart().innerHTML !== yp ||
            zg(t, Vc(o, r.getStart())),
          (37 !== n && 39 !== n) || zg(t, Vc(o, r.getStart()));
      }),
      {
        get: a.get,
        has: a.has,
        ...
        remove: function (e, t, n, r) {
          var o = e,
            ...
            a = n,
            u = r;
          bh(c).formatter.remove(o, i, a, u);
        },
        toggle: function (e, t, n) {
          var r = e,
            o = t,
            i = n;
          bh(c).formatter.toggle(r, o, i);
        },
        match: function (e, t, n, r) {
          return (
            (o = e),
            ...
            (a = n),
            (u = r),
            bh(c).formatter.match(o, i, a, u)
          );
          var o, i, a, u;
        },
        closest: function (e) {
          return (t = e), bh(c).formatter.closest(t);
          var t;
        },
        matchAll: function (e, t) {
          return (n = e), (r = t), bh(c).formatter.matchAll(n, r);
          var n, r;
        },
        matchNode: function (e, t, n, r) {
          return (
            ...
            (a = n),
            (u = r),
            bh(c).formatter.matchNode(o, i, a, u)
          );
          var o, i, a, u;
        },
        canApply: function (e) {
          return (t = e), bh(c).formatter.canApply(t);
          var t;
        },
        formatChanged: function (e, t, n, r) {
          return (
            ...
            (u = n),
            (s = r),
            bh(c).formatter.formatChanged(o, i, a, u, s)
          );
          var o, i, a, u, s;
        },
        getCssText: R(Qv, c),
    ...
    var e,
      ...
      d = {
        ...
        beforeChange: function () {
          var e = l,
            t = c;
          bh(s).undoManager.beforeChange(e, t);
        },
        add: function (e, t) {
          return (
            (n = d),
            ...
            (a = e),
            (u = t),
            bh(s).undoManager.add(n, r, o, i, a, u)
          );
          var n, r, o, i, a, u;
        },
        undo: function () {
          return (e = d), (t = l), (n = f), bh(s).undoManager.undo(e, t, n);
          var e, t, n;
        },
        redo: function () {
          return (e = f), (t = d.data), bh(s).undoManager.redo(e, t);
          var e, t;
        },
        clear: function () {
          var e = d,
            t = f;
          bh(s).undoManager.clear(e, t);
        },
        reset: function () {
          var e = d;
          bh(s).undoManager.reset(e);
        },
        hasUndo: function () {
          return (e = d), (t = f), bh(s).undoManager.hasUndo(e, t);
          var e, t;
        },
        hasRedo: function () {
          return (e = d), (t = f), bh(s).undoManager.hasRedo(e, t);
          var e, t;
        },
        transact: function (e) {
          return (t = d), (n = l), (r = e), bh(s).undoManager.transact(t, n, r);
          var t, n, r;
        },
        ignore: function (e) {
          var t = l,
            n = e;
          bh(s).undoManager.ignore(t, n);
        },
        extra: function (e, t) {
          var n = d,
            r = f,
            o = e,
            i = t;
          bh(s).undoManager.extra(n, r, o, i);
        },
      };
    return (
      ph(s) ||
        ...
        n.on("BeforeExecCommand", function (e) {
          eb(e.command) || (mh(r, o), r.beforeChange());
        }),
            ...
            ((33 <= n && n <= 36) || (37 <= n && n <= 40) || 45 === n
              ...
              : ((t = (e.ctrlKey && !e.altKey) || e.metaKey),
                !(n < 16 || 20 < n) ||
                  ...
                  r.typing ||
                  t ||
                  (r.beforeChange(), dh(r, !0, o), r.add({}, e), i.set(!0))));
        }),
  ...
  function fb(e, t) {
    return sb(kt.fromDom(e), kt.fromDom(t.container())).map(function (e) {
  ...
  function mb(e, t) {
    return M(bm(t, e).reverse(), function (e) {
      return Wr(e);
    }).each(Ln);
  }
  function gb(e, t, n, r) {
    if (Wr(n)) return pm(n), nf(n.dom);
    0 ===
      U(Lt(r), function (e) {
        return !Wr(e);
      }).length &&
  ...
  function pb(e, t, n) {
    if (Wr(n)) return Ln(n), Wr(t) && pm(t), nf(t.dom);
    var r = rf(n.dom);
    return (
      Y(db(t), function (e) {
        Pn(n, e);
  ...
  function vb(e, t, n) {
    return (
      ...
      hb(!1, n),
      (Ve((o = n), (r = t))
        ? ((i = bm(r, o)), ve.from(i[i.length - 1]))
        : ve.none()
      ).fold(R(pb, e, t, n), R(gb, e, t, n))
    );
    var r, o, i;
  }
  function bb(e, t, n, r) {
    ...
    var e,
      ...
      l =
        ...
        ((o = t.selection.getRng()).collapsed
          ? ((a = r),
            (u = fb((i = e), ss.fromRangeStart(o))),
            (s = u.bind(function (e) {
              return Ql(a, i, e.position).bind(function (e) {
                return fb(i, e).map(function (e) {
                  return (
                    (t = i),
                    (n = a),
          ...
          return bb(c, n, e.from.block, e.to.block);
        }));
    return (
      l.each(function (e) {
        t.selection.setRng(e.toRange());
  ...
  function xb(e) {
    ...
    return (
      ...
      !Cb((u = i), (s = a).startContainer) && !Cb(u, s.endContainer) && c && l
        ? ((t = e).setContent(""), t.selection.setCursorLocation(), !0)
        : ((n = f),
          (r = e.selection),
          (o = r.getRng()),
          dn(
            sb(n, kt.fromDom(o.startContainer)),
            sb(n, kt.fromDom(o.endContainer)),
            function (e, t) {
              return (
                !1 === je(e, t) &&
                (o.deleteContents(),
                bb(n, !0, e, t).each(function (e) {
                  r.setRng(e.toRange());
                }),
                !0)
              );
  ...
  function wb(e, t) {
    return !e.selection.isCollapsed() && xb(e);
  }
  ...
  function kb(e, t, n) {
    var r = tc(1, e.getBody(), t),
      ...
      i = o.getNode();
    if (Ec(i)) return Sb(1, e, i, !o.isAtEnd(), !1);
    var a = o.getNode(!0);
    if (Ec(a)) return Sb(1, e, a, !1, !1);
    var u = e.dom.getParent(o.getNode(), function (e) {
      return xy(e) || Cy(e);
    });
    return Ec(u) ? Sb(1, e, u, !1, n) : ve.none();
  }
  function Nb(e, t, n) {
    return t.collapsed ? kb(e, t, n).getOr(t) : t;
  }
  function _b(e) {
    return np(e) || Qg(e);
  }
  ...
  function Rb(n, r, e, t, o, i) {
    var a, u;
    return (
      Sb(t, n, i.getNode(!o), o, !0).each(function (e) {
        var t;
        r.collapsed
          ? ((t = r.cloneRange()),
            o
  ...
  function Db(e, t) {
    ...
    if (a(s)) return Rb(e, n, u.getNode(), r, t, s);
    var c = i(s);
    return !!(c && a(c) && ac(s, c)) && Rb(e, n, u.getNode(), r, t, c);
  }
  function Tb(l, f, d) {
      ...
      return (
        ...
        nc(!(i = f), (a = d)).fold(function () {
          ...
          ? ((t = l),
            (n = d),
            (r = e.getNode(!1 === f)),
            sb(kt.fromDom(t), kt.fromDom(n.getNode()))
              .map(function (e) {
                return Wr(e) ? wy.remove(e.dom) : wy.moveToElement(r);
              })
              .orThunk(function () {
                return ve.some(wy.moveToElement(r));
              }))
          : (f && rp(d)) || (!1 === f && np(d))
          ? ve.some(wy.moveToPosition(e))
          : ve.none()
      );
      var t, n, r, o, i, a, u, s;
      function c(e) {
    ...
    return Ob(m, e)
      ...
      .fold(function () {
        return (
          ...
          (d = kt.fromDom(s)),
          (!1 === c && rp(f)
            ? ve.some(wy.remove(f.getNode(!0)))
            : c && np(f)
            ? ve.some(wy.remove(f.getNode()))
            : !1 === c && np(f) && Nm(d, f)
            ? sp(d, f).map(function (e) {
            ...
            : ((r = s),
              ...
              zn(a) && a.getAttribute("data-mce-caret") === u
                ? ((n = o.getNode(!1 === (t = e))),
                  (t && Yn(n.nextSibling)
                    ? ve.some(wy.moveToElement(n.nextSibling))
                    : !1 === t && Yn(n.previousSibling)
                    ? ve.some(wy.moveToElement(n.previousSibling))
                    : ve.none()
                  ).fold(function () {
                    return Tb(r, e, o);
                  }, ve.some))
                : Tb(r, e, o).bind(function (e) {
                    return (
                      (t = r),
                      (n = o),
                      e.fold(
                        function (e) {
                          return ve.some(wy.remove(e));
                        },
                        function (e) {
                          return ve.some(wy.moveToElement(e));
                        },
                        function (e) {
                          return Js(n, e, t)
                            ? ve.none()
      ...
      Ob(e, n.parentNode)
        ...
        .fold(function () {
          return (
            ...
            Jm(e, t, kt.fromDom(e.selection.getNode())),
            cb(e),
            !0
          );
        }, w)
  ...
  function Ib(e, t) {
    return (e.selection.isCollapsed() ? Bb : Pb)(e, t);
  }
  function Mb(e, t) {
    return (
  ...
  function Fb(e) {
    return Sy(e) && e.data[0] === wo;
  }
  function Ub(e) {
    return Sy(e) && e.data[e.data.length - 1] === wo;
  }
  function zb(e) {
  ...
  function Hb(e, t) {
    return (
      e
        ? function (e) {
            if (Sy(e.previousSibling))
              return (
                Ub(e.previousSibling) || e.previousSibling.appendData(wo),
                e.previousSibling
              );
            if (Sy(e)) return Fb(e) || e.insertData(0, wo), e;
            var t = zb(e);
        ...
        : function (e) {
            if (Sy(e.nextSibling))
              return (
                Fb(e.nextSibling) || e.nextSibling.insertData(0, wo),
                e.nextSibling
              );
            if (Sy(e)) return Ub(e) || e.appendData(wo), e;
            var t = zb(e);
            return (
              e.nextSibling
  ...
  function jb(e, t) {
    return jn(e.container()) ? Hb(t, e.container()) : Hb(t, e.getNode());
  }
  function Vb(e, t) {
    var n = t.get();
    ...
    return e.fold(
      ...
      function (e) {
        return rf(e).map(function (e) {
          if (Vb(e, n)) return ss(n.get(), n.get().length - 1);
          yc(n.get());
          var t = jb(e, !1);
  ...
  function Yb(e, t, n) {
    return ib(e, t, n).filter(R(Xb, t));
  }
  function Gb(e, t, n) {
    var r = yy(n);
    return Yb(e, t, r).bind(function (e) {
      return tf(e, r).isNone() ? ve.some(Ny.start(e)) : ve.none();
    });
  }
  function Jb(e, t, n) {
    var r = by(n);
    return Yb(e, t, r).bind(function (e) {
      return ef(e, r).isNone() ? ve.some(Ny.end(e)) : ve.none();
    });
  }
  function Qb(e, t, n) {
    var r = yy(n),
  ...
  function Zb(e) {
    return (
      ...
      "rtl" === Za.DOM.getStyle(t, "direction", !0) ||
        ((n = t.textContent), vy.test(n)))
    );
    var t, n;
  }
  function ey(e, t, n) {
    return $b([Kb, Gb, Jb, Qb], [e, t, n]).filter(Zb);
  }
  function ty(e) {
  ...
  function oy(a, e, u, t, n, s) {
    return dn(ib(e, u, t), ib(e, u, n), function (e, t) {
      return e !== t &&
  ...
  function iy(e, r) {
    return e.fold(w, function (e) {
      return (n = r), !(ty((t = e)) === ty(n) && _y(t) === _y(n));
      var t, n;
    });
  }
  function ay(e, t) {
    return e
      ? t.fold(i(ve.some, Ny.start), ve.none, i(ve.some, Ny.after), ve.none)
      : t.fold(ve.none, i(ve.some, Ny.before), ve.none, i(ve.some, Ny.end));
  }
  function uy(e, a, u, s) {
    var t = ab(e, s),
      c = ey(a, u, t);
        ...
        return (
          ...
          Ql(t, r, i)
            ...
            .fold(
              ...
              function (e) {
                return ey(n, r, e).map(R(oy, t, n, r, i, e)).filter(R(iy, o));
              }
            )
            .filter(Zb)
        );
    ...
    for (var o, i, a, u, s = Ic(n), c = r, l = []; c; ) {
      ...
      if (Wn(f.getNode(!1)))
        return t === uc.Forwards
          ? {
              positions: Ry(t, l).concat([f]),
              breakType: cy.Br,
              breakAt: ve.some(f),
            }
          : { positions: Ry(t, l), breakType: cy.Br, breakAt: ve.some(f) };
      if (f.isVisible()) {
        if (e(c, f)) {
          var d =
            ((o = c),
            Wn((i = f).getNode(t === uc.Forwards))
              ...
              ? cy.Block
              : cy.Wrap);
          return { positions: Ry(t, l), breakType: d, breakAt: ve.some(f) };
        }
        l.push(f), (c = f);
      } else c = f;
    }
    return { positions: Ry(t, l), breakType: cy.Eol, breakAt: ve.none() };
  }
  function Ty(n, r, o, e) {
    return r(o, e)
  ...
  var Iy,
    My,
    Fy = R(Dy, ss.isAbove, -1),
    Uy = R(Dy, ss.isBelow, 1),
    zy = R(Ty, -1, Fy),
    Hy = R(Ty, 1, Uy);
  ...
  function Yy(e, o, i) {
    return (
      void 0 === i && (i = w),
      me(e, function (e, t) {
        if (Ky(o, t)) return i(t) ? t : e;
        if (Ky(o, e)) return i(e) ? e : t;
        var n = Math.min($y(e, o), Wy(e, o)),
          r = Math.min($y(t, o), Wy(t, o));
        return (r === n && se(t, "node") && UC(t.node)) || r < n ? t : e;
      })
    );
  }
  ...
  function Jy(e, t, n) {
    ...
    var o,
      i,
      a,
      u = Ly(U(xe(e.getElementsByTagName("*")), Ks)),
      s = U(u, R(Xy, n));
    if (
      (a = Yy(s, t, r)) &&
      (a = Yy(
        (function (e, r, t) {
          ...
          return (
            o.push(r),
            Gy(Iy.Up, e, R(n, Tu), r.node, t),
            Gy(Iy.Down, e, R(n, Ou), r.node, t),
            o
          );
        })(e, a, r(a)),
        t,
      ...
      return { node: (o = a).node, before: $y(o, (i = t)) < Wy(o, i) };
    return null;
  }
  function Qy(e, t) {
  ...
  function e0(e, t, n, r, o, i) {
    ...
    if (!n.collapsed) {
      var l = Pu(n);
      if (i(l)) return Sb(t, e, l, t === uc.Backwards, !1);
    }
    var f = rc(t, e.getBody(), n);
    if (c(f)) return Eb(e, f.getNode(!a));
    var d = ab(a, s(f)),
      m = Hr(n);
    if (!d) return m ? ve.some(n) : ve.none();
    if (c(d)) return Sb(t, e, d.getNode(!a), a, !1);
    var g = s(d);
    return g && c(g) && ac(d, g)
      ? Sb(t, e, g.getNode(!a), a, !1)
      : m
      ? Zy(e, d.toRange(), !1)
      : ve.none();
  }
  function t0(t, e, n, r, o, i) {
    ...
    if (!u) return ve.none();
    var c,
      l = U((s ? FC : MC)(t.getBody(), Vy(1), a), qy(1)),
      f = u.left,
      d = Yy(l, f);
    if (d && i(d.node)) {
      var m = Math.abs(f - d.left),
        g = Math.abs(f - d.right);
      return Sb(e, t, d.node, m < g, !1);
    }
    if ((c = r(a) ? a.getNode() : o(a) ? a.getNode(!0) : Pu(n))) {
      var p = (function (e, t, n, r) {
        ...
        h = Yy(U(p, qy(1)), f);
      if (h) return Zy(t, h.position.toRange(), !1);
      if ((h = pe(U(p, qy(0))))) return Zy(t, h.position.toRange(), !1);
    }
    return 0 === l.length
      ? HC(t, s)
          .filter(s ? o : r)
        ...
        !Is(g) ||
          ...
          r.selection.isCollapsed() &&
            Y(U(t, n), function (e) {
              ...
              ey(n, r.getBody(), t).bind(function (e) {
                return i0(r, o, e);
              });
            }));
      }),
  ...
  function c0(n, t, r) {
    if (Is(n)) {
      var e = HC(n, t).getOrThunk(function () {
        var e = n.selection.getRng();
        return t ? ss.fromRangeEnd(e) : ss.fromRangeStart(e);
      });
      return ey(R(ob, n), n.getBody(), e).exists(function (e) {
        var t = ny(e);
        return qb(r, t).exists(function (e) {
          return r0(n, e), !0;
        });
      });
    }
  ...
  function l0(t, n) {
    return function (e) {
      return qb(n, e).exists(function (e) {
        return r0(t, e), !0;
      });
    };
  }
  function f0(r, o, i, a) {
    ...
    r.undoManager.ignore(function () {
      ...
      r.selection.setRng(
        ...
        ey(s, u, ss.fromRangeStart(r.selection.getRng())).map(ry).map(l0(r, o));
    }),
      r.nodeChanged();
  }
  function d0(e, t, n) {
    if (e.selection.isCollapsed() && Is(e)) {
      ...
      return (
        ...
        (f = ey(l, c, u))
          .bind(function (e) {
            return a
              ? e.fold(J(ve.some(ry(e))), ve.none, J(ve.some(ny(e))), ve.none)
              : e.fold(ve.none, J(ve.some(ny(e))), ve.none, J(ve.some(ry(e))));
          })
          .map(l0(i, o))
          .getOrThunk(function () {
            var t = zc(a, c, u),
            ...
            return dn(f, e, function () {
              return ib(l, c, u).exists(function (e) {
                return (
              ...
              .orThunk(function () {
                return e.bind(function (e) {
                  return t.map(function (e) {
                    return a ? f0(i, o, u, e) : f0(i, o, e, u), !0;
                  });
                });
              })
              .getOr(!1);
  ...
  function g0(g, p) {
    var t,
      ...
      h = U(
        z((t = bm(n, e)), mo).fold(J(t), function (e) {
          return t.slice(0, e);
        }),
        m0
      );
  ...
  function p0(e, t) {
    return !!e.selection.isCollapsed() && g0(e, t);
  }
  function h0(e, t, n) {
    return e._selectionOverrides.hideFakeCaret(), Jm(e, t, kt.fromDom(n)), !0;
  }
  function v0(e, t) {
      ...
      ? ((i = e),
        ...
        u(c)
          ...
          : ve
              ...
              .exists(function (e) {
                return h0(i, a, e.getNode(!a));
              }))
      : ((r = t), (o = (n = e).selection.getNode()), !!Jn(o) && h0(n, r, o));
    var n, r, o, i, a, u, s, c;
  }
  function b0(e) {
    var t = parseInt(e, 10);
    ...
    e.queryCommandState("InsertUnorderedList") ||
      ...
      Y(qC(e), function (e) {
        var t,
          ...
          u = y0(d, kt.fromDom(a));
        "outdent" === r
          ? ((t = Math.max(0, b0(a.style[u]) - o)),
            n.setStyle(a, u, t ? t + i : ""))
          : ((t = b0(a.style[u]) + o + i), n.setStyle(a, u, t));
      });
  }
  function S0(e, t) {
    if (e.selection.isCollapsed() && C0(e)) {
      var n = e.dom,
        r = e.selection.getRng(),
        o = ss.fromRangeStart(r),
        i = n.getParent(r.startContainer, n.isBlock);
      if (null !== i && op(kt.fromDom(i), o)) return w0(e, "outdent"), !0;
    }
    return !1;
  }
  function E0(e, t) {
  ...
  function _0(e) {
    ...
    if (s && zn(s) && l) {
      ...
      if (
        ...
        (m = c),
        (g = s),
        !F(vm(kt.fromDom(g), kt.fromDom(m)), function (e) {
          return N0(d, e.dom);
        }))
      ) {
        for (
          ...
          (p = u),
            jn((h = s)) || (zn(h) && !N0(p, h) && !Jc(h))
              ? (function (e, t) {
                  if (jn(t)) {
                    if (0 === t.nodeValue.length) return 1;
                    if (
                      /^\s+$/.test(t.nodeValue) &&
                      (!t.nextSibling || N0(e, t.nextSibling))
                    )
                      return 1;
                  }
                })(u, s)
  ...
  function R0(e, t) {
    ...
    if (n)
      return "compositionstart" === t.type
        ? (t.preventDefault(), t.stopPropagation(), void A0(e, n))
        : void (Mr(n) && (A0(e, n), e.undoManager.add()));
  }
  function D0(e, t, n) {
    var r,
      o,
    ...
    return pr(kt.fromDom(e.container()), mo, t)
      ...
      .exists(function () {
        if (
          ...
          (m = y),
          v
            ? ((p = d.dom), Uy(p, m).breakAt.isNone())
            : ((g = d.dom), Fy(g, m).breakAt.isNone()))
        ) {
          var e =
            ((t = b),
            (r = x),
            (o = v),
            "" === (n = C)
              ? ((l = o), I0(t, (f = kt.fromTag("br")), l), L0(f))
              : ((i = t),
                (a = o),
                (u = r),
                (s = kt.fromTag(n)),
  ...
  function H0(t, e) {
    ...
    return e0(t, n, r, Qg, Zg, Jn).exists(function (e) {
      return Qy(t, e), !0;
    });
  }
  function j0(t, e) {
    var n = e ? 1 : -1,
      r = t.selection.getRng();
    return t0(t, n, r, Qg, Zg, Jn).exists(function (e) {
      return Qy(t, e), !0;
    });
  }
  function V0(e, t) {
    return n0(e, t, t ? Zg : Qg);
  }
  ...
  function $0(e, t, n) {
    var r,
      o,
      i = e(t, n);
    return (i.breakType === cy.Wrap && 0 === i.positions.length) ||
      (!Wn(n.getNode()) && i.breakType === cy.Br && 1 === i.positions.length)
      ? ((r = e),
        (o = t),
            ...
            function (e) {
              ...
              (r = ks((n = u)))
                ? n.undoManager.transact(function () {
                    ...
                    t.setStart(e.dom, 0), t.setEnd(e.dom, 0), Qy(n, t);
                  })
                : Qy(n, t.toRange());
            }
          );
  ...
  function X0(e, t, n, r) {
      ...
      return (
        ...
        K0(
          ...
          (v = Z((m = a = p).getClientRects())
            .bind(function (e) {
              return KC(d, e.left, e.top);
            })
            .bind(function (e) {
              return By(
                nf((t = e))
                  .map(function (e) {
                    return [e].concat(Uy(t, e).positions);
                  })
                  .getOr([]),
                m
              );
            ...
            .orThunk(function () {
              return Q(a.getClientRects()).bind(function (e) {
                return Oy(Hy(o, ss.after(i)), e.left);
              });
            })
            .getOr(ss.after(i)))
        ),
    ...
    var v =
      ...
      Q((f = c = p).getClientRects())
        .bind(function (e) {
          return WC(l, e.left, e.top);
        })
        .bind(function (e) {
          return By(
            rf((t = e))
              .map(function (e) {
                return Fy(t, e).positions.concat(e);
              })
              .getOr([]),
            f
          );
        ...
        .orThunk(function () {
          return Q(c.getClientRects()).bind(function (e) {
            return Oy(zy(u, ss.before(s)), e.left);
          });
        })
        .getOr(ss.before(s)));
    return K0(e, t, v), !0;
  ...
  function lC(a, e) {
    ...
    function n(e) {
      ...
      if (!jn(m) || !(e ? 0 < r : r < m.nodeValue.length)) {
        ...
        if (iC(m, "TABLE") || iC(m, "HR")) return (s && !e) || (!s && e);
        var o = new Rr(m, b);
        for (
          jn(m) &&
    ...
    F &&
      ...
      /^(LI|DT|DD)$/.test(C) && c.isEmpty(b)
        ? ((k = t),
          ...
          N !== E.getBody() &&
            ((D = (A = tC((R = N)) && tC(R.parentNode) ? "LI" : A)
              ? k(A)
              : I.create("BR")),
            rC(N, _, !0) && rC(N, _, !1)
              ? eC(N, "LI")
        ...
        : (p && b === a.getBody()) ||
          ((p = p || "P"),
          Pr(b)
            ? ((u = zr(b)), c.isEmpty(b) && oC(b), cC(a, u), Q0(a, u))
            : n()
            ? r()
            : n(!0)
            ...
            : ((S = (w = d).cloneRange()).setStart(
                w.startContainer,
                uC(!0, w.startContainer, w.startOffset)
              ),
              S.setEnd(w.endContainer, uC(!1, w.endContainer, w.endOffset)),
              ...
              c.isEmpty(b) && oC(b),
              u.normalize(),
              c.isEmpty(u) ? (c.remove(u), r()) : (cC(a, u), Q0(a, u))),
          c.setAttrib(u, "id", ""),
  ...
  function mC(e, t) {
    GC(e.getBody(), t) || $t(kt.fromDom(t), kt.fromTag("br"));
    var n = kt.fromTag("br");
    $t(kt.fromDom(t), n), fC(e, n.dom, !1), e.undoManager.add();
  }
  function gC(e) {
    return e && "A" === e.nodeName && "href" in e;
  }
  function pC(e) {
    return e.fold(D, gC, gC, D);
  }
  function hC(e, t) {
    t.fold(te, R(dC, e), R(mC, e), te);
  }
  function vC(e, t) {
    var n,
      r,
  ...
  function yC(e, t) {
    return bC(e, e.getParam("no_newline_selector", ""));
  }
  function CC(n) {
    return function (e, t) {
      return ("" === ks(e)) === n;
  ...
  function RC(e, t) {
    ...
    (n = e),
      ...
      $b(
        [
          AC([yC], JC.none()),
          AC([wC("summary", !0)], JC.br()),
          AC([SC(!0), EC(!1), NC], JC.br()),
          AC([SC(!0), EC(!1)], JC.block()),
          AC([SC(!0), EC(!0), NC], JC.block()),
          AC([SC(!0), EC(!0)], JC.br()),
          AC([xC(!0), NC], JC.br()),
          AC([xC(!0)], JC.block()),
          AC([CC(!0), NC, _C], JC.block()),
          AC([CC(!0)], JC.br()),
          AC([kC], JC.br()),
          AC([CC(!1), NC], JC.br()),
          AC([_C], JC.block()),
  ...
  function OC(e, t, n) {
    n && !e.get()
      ? t.on("NodeChange", DC, !0)
      : !n && e.get() && t.off("NodeChange", DC),
      e.set(n);
  }
  function BC(n, r) {
    var e = r.container(),
  ...
  function IC(e) {
    var o,
      ...
      p = s0(e);
    return (
      e.on("keyup compositionstart", R(R0, e)),
      (g = p),
      (m = e).on("keydown", function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          z0(
            [
              { keyCode: Lf.RIGHT, action: U0(T0, t, !0) },
              { keyCode: Lf.LEFT, action: U0(T0, t, !1) },
              { keyCode: Lf.UP, action: U0(O0, t, !1) },
              { keyCode: Lf.DOWN, action: U0(O0, t, !0) },
              { keyCode: Lf.RIGHT, action: U0(G0, t, !0) },
              { keyCode: Lf.LEFT, action: U0(G0, t, !1) },
              { keyCode: Lf.UP, action: U0(J0, t, !1) },
              { keyCode: Lf.DOWN, action: U0(J0, t, !0) },
              { keyCode: Lf.RIGHT, action: U0(H0, t, !0) },
              { keyCode: Lf.LEFT, action: U0(H0, t, !1) },
              { keyCode: Lf.UP, action: U0(j0, t, !1) },
              { keyCode: Lf.DOWN, action: U0(j0, t, !0) },
              { keyCode: Lf.RIGHT, action: U0(a0, t, n, !0) },
              { keyCode: Lf.LEFT, action: U0(a0, t, n, !1) },
              {
                keyCode: Lf.RIGHT,
                ctrlKey: !o.isOSX(),
                altKey: o.isOSX(),
              ...
              { keyCode: Lf.UP, action: U0(F0, t, !1) },
              { keyCode: Lf.DOWN, action: U0(F0, t, !0) },
            ],
            r
          ).each(function (e) {
            r.preventDefault();
      ...
      (f = e).on("keydown", function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          z0(
            [
              { keyCode: Lf.BACKSPACE, action: U0(S0, (t = f), !1) },
              { keyCode: Lf.BACKSPACE, action: U0(Ib, t, !1) },
              { keyCode: Lf.DELETE, action: U0(Ib, t, !0) },
              { keyCode: Lf.BACKSPACE, action: U0(Db, t, !1) },
              { keyCode: Lf.DELETE, action: U0(Db, t, !0) },
              { keyCode: Lf.BACKSPACE, action: U0(d0, t, n, !1) },
              { keyCode: Lf.DELETE, action: U0(d0, t, n, !0) },
              { keyCode: Lf.BACKSPACE, action: U0(bg, t, !1) },
              { keyCode: Lf.DELETE, action: U0(bg, t, !0) },
              { keyCode: Lf.BACKSPACE, action: U0(Mb, t, !1) },
              { keyCode: Lf.DELETE, action: U0(Mb, t, !0) },
              { keyCode: Lf.BACKSPACE, action: U0(v0, t, !1) },
              { keyCode: Lf.DELETE, action: U0(v0, t, !0) },
              { keyCode: Lf.BACKSPACE, action: U0(wb, t, !1) },
              { keyCode: Lf.DELETE, action: U0(wb, t, !0) },
              { keyCode: Lf.BACKSPACE, action: U0(yb, t, !1) },
              { keyCode: Lf.DELETE, action: U0(yb, t, !0) },
              { keyCode: Lf.BACKSPACE, action: U0(p0, t, !1) },
              { keyCode: Lf.DELETE, action: U0(p0, t, !0) },
            ],
            r
          ).each(function (e) {
            r.preventDefault();
      ...
      f.on("keyup", function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          z0(
            [
              { keyCode: Lf.BACKSPACE, action: U0(Lb, (t = f)) },
              { keyCode: Lf.DELETE, action: U0(Lb, t) },
            ],
            n
          ));
      }),
      ...
      (c = e).on("keydown", function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ((t = e),
          z0([{ keyCode: Lf.SPACEBAR, action: U0(LC, c) }], t).each(function (
            e
          ) {
            t.preventDefault();
          }));
      ...
      (u = e).on("keydown", function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          z0(
            [
              { keyCode: Lf.END, action: U0(B0, (t = u), !0) },
              { keyCode: Lf.HOME, action: U0(B0, t, !1) },
              { keyCode: Lf.END, action: U0(V0, t, !0) },
              { keyCode: Lf.HOME, action: U0(V0, t, !1) },
              { keyCode: Lf.END, action: U0(c0, t, !0, n) },
              { keyCode: Lf.HOME, action: U0(c0, t, !1, n) },
            ],
            r
          ).each(function (e) {
            r.preventDefault();
      ...
      ZC.os.isOSX() ||
        ...
        o.on("keyup", function (e) {
          ...
          !1 === e.isDefaultPrevented() &&
            ...
            z0(
              [
                { keyCode: Lf.PAGE_UP, action: U0(c0, (t = o), !1, (n = i)) },
                { keyCode: Lf.PAGE_DOWN, action: U0(c0, t, !0, n) },
              ],
              r
            )),
            TC(e) && a.get() && (OC(a, o, !1), o.nodeChanged());
        })),
      p
    );
  }
  ((My = Iy = Iy || {})[(My.Up = -1)] = "Up"), (My[(My.Down = 1)] = "Down");
  var MC = R(jy, Iy.Up, Tu, Ou),
    FC = R(jy, Iy.Down, Ou, Tu),
    UC = Yn,
    zC = Ys,
    HC = function (e, t) {
      var n = e.selection.getRng(),
      ...
      return (o = ss.fromRangeStart(n)), Q((i = Fy(r, o)).positions);
    },
    jC = R(u0, !0),
    VC = R(u0, !1),
    qC = function (e) {
    ...
    t1 = R(BC, " "),
    n1 =
      ((r1.prototype.nodeChanged = function (e) {
        var t,
          n,
          r,
      ...
      (r1.prototype.isSameElementPath = function (e) {
        var t,
        ...
        return e.on(function (e) {
          ...
          e.dragging &&
            ...
            (t = {
              pageX:
                ((p = w),
                (h = (g = S).inline ? i1(g.getBody()) : { left: 0, top: 0 }),
                (C = (y = g).getBody()),
                (v = y.inline
                  ...
                  pageX:
                    (b = (function (e, t) {
                      ...
                      var n,
                        ...
                        i,
                        a,
                        u = i1(e.getContentAreaContainer()),
                        s =
                          ((r = (n = e).getBody()),
    ...
    function a(e) {
      ...
      e.isDefaultPrevented() ||
        ((t = e.dataTransfer) &&
          ...
          (e.preventDefault(),
          "drop" === e.type && Fv(i, "Dropped file type is not supported")));
    }
    function u(e) {
      gd(i, e.target) && a(e);
    }
      ...
      (n = e).on("drop", function (e) {
        var t =
          void 0 !== e.clientX
            ...
            : null;
        (!B1(t) && "false" !== n.dom.getContentEditableParent(t)) ||
          e.preventDefault();
      }),
  ...
  function f1(l) {
    function f(e) {
      return e !== x && (M1(e) || Jn(e)) && y.isChildOf(e, x);
    }
    function c(e) {
    ...
    return (
      xt.ceFalse &&
        ...
        (l.on("mouseup", function (e) {
          var t = r();
          t.collapsed && sv(l, e.clientX, e.clientY) && kb(l, t, !1).each(d);
        }),
        l.on("click", function (e) {
          var t = l1(l, e.target);
          t &&
            (M1(t) && (e.preventDefault(), l.focus()),
            I1(t) && y.isChildOf(t, b.getNode()) && h());
        }),
        ...
        l.on(
          ...
          function (e) {
            var t = e.target,
              n = l1(l, t);
            M1(n)
              ? (e.preventDefault(), Eb(l, n).each(p))
              : f(t) && Eb(l, t).each(p);
          },
          !0
        ),
        l.on("mousedown", function (e) {
          ...
          (s !== x && "HTML" !== s.nodeName && !y.isChildOf(s, x)) ||
            !1 === sv(l, e.clientX, e.clientY) ||
            ((t = l1(l, s))
              ? M1(t)
                ? (e.preventDefault(), Eb(l, t).each(p))
                : (h(),
                  (I1(t) && e.shiftKey) ||
              ...
              : !1 === Ks(s) &&
                (h(),
                E(),
                (n = Jy(x, e.clientX, e.clientY)) &&
                  ((r = s),
                  (o = n.node),
                  (a = y.getParent(r, C)),
                  (u = y.getParent(o, C)),
                  (!K(a) &&
                    ((r !== u && y.isChildOf(a, u) && !1 === M1(l1(l, a))) ||
                      (!y.isChildOf(u, a) &&
        ...
        l.on("keypress", function (e) {
          Lf.modifierPressed(e) || (M1(b.getNode()) && e.preventDefault());
        }),
        ...
        (e = du(function () {
          ...
          n.removed ||
            ...
            ((e = n.selection.getRng()).collapsed &&
              ((t = Nb(n, e, !1)), n.selection.setRng(t)));
        }, 0)),
  ...
  function y1(e) {
    var t;
    !0 !== e.removed &&
      (ph((t = e)) || t.load({ initial: !0, format: "html" }),
  ...
  function C1(t, e) {
    ...
    n.inline || (t.getElement().style.visibility = t.orgVisibility),
      ...
      t.inline &&
        (F1.addClass(r, "mce-content-body"),
    ...
    (v.disabled = !0),
      ...
      t.readonly ||
        (t.inline &&
          "static" === F1.getStyle(v, "position", !0) &&
      ...
      (t.parser =
        ((i = Kh(p1((u = t)), u.schema)).addAttributeFilter(
      ...
      (t.selection = Mh(t.dom, t.getWin(), t.serializer, t)),
      (t.annotator = Ul(t)),
      (t.formatter = Zv(t)),
      (t.undoManager = tb(t)),
      (t._nodeChangeDispatcher = new n1(t)),
      (t._selectionOverrides = f1(t)),
      (m = t),
      (g = fu()),
      (p = iu(!1)),
      (h = mu(function (e) {
      ...
      (E = function (e, t) {
        ...
        !(function (e) {
          ...
          (r =
            !(
              nb((o = e)) &&
              !(rb(o) || ("keyup" === o.type && 229 === o.keyCode))
            ) &&
            (function (e, t, n) {
          ...
          (("" !== x.getAttrib(n, hy)) === r && !t) ||
            (x.setAttrib(n, hy, r ? S : null),
    ...
    (function (t) {
      ...
      t.fire("PreInit"),
        e.browser_spellcheck ||
          e.gecko_spellcheck ||
          ((n.body.spellcheck = !1), F1.setAttrib(r, "spellcheck", "false")),
        (t.quirks = d1(t)),
        t.fire("PostRender");
    ...
    return (
      ...
      X(Ls(e))
        ...
        : ((u = (o = e).getElement()),
          o.inline
            ? S1(null)
            : ((i = u), (a = z1.create("div")), z1.insertAfter(a, i), S1(a)))
    );
  }
  function k1(e) {
    var n, t, r, o, i, a, u, s;
    e.fire("ScriptsLoaded"),
      ...
      ne(_e(_e({}, Rv.get("default").icons), Rv.get(t).icons), function (e, t) {
        ke(r, t) || n.ui.registry.addIcon(t, e);
      }),
      (a = Ls((o = e))),
      X(a)
        ? ((o.settings.theme = w1(a)),
          (i = Lv.get(a)),
          (o.theme = new i(o, Lv.urls[a])),
          o.theme.init &&
            o.theme.init(
              o,
              Lv.urls[a] || o.documentBaseUrl.replace(/\/$/, ""),
              o.$
            ))
        : (o.theme = {}),
      (s = []),
    ...
    return (
      ...
      e.inline
        ...
        : ((p = x1((m = e), (g = h))),
          g.editorContainer &&
            ((U1.get(g.editorContainer).style.display = m.orgDisplay),
            (m.hidden = U1.isHidden(g.editorContainer))),
          (m.getElement().style.display = "none"),
          U1.setAttrib(m.id, "aria-hidden", "true"),
          void (p || C1(m)))
    );
  }
  function N1(e) {
        ...
        (e = f),
          ...
          !1 === cu.hasCode(u) &&
            ...
            e.add(a, te, void 0, function () {
              Uv(i, "LanguageLoadError", zv("language", a, u));
            })),
          (t = f),
          Y(
            (function (e) {
            ...
            function (e) {
              t.add(e.url, te, void 0, function () {
                Uv(
                  n,
                  "IconsLoadError",
                  zv("icons", e.url, e.name.getOrUndefined())
                );
              });
            }
          ),
          ...
          Et.each(r.getParam("external_plugins"), function (e, t) {
            Pv.load(t, e, te, void 0, function () {
              Hv(r, e, t);
            }),
              ...
              (N1(e)
                ? ((e = e.substr(1, e.length)),
                  ...
                  Et.each(t, function (e) {
                    ...
                    Pv.load(t.resource, t, te, void 0, function () {
                      Hv(r, t.prefix + t.resource + t.suffix, t.resource);
                    });
                  }))
                : ((n = {
                    prefix: "plugins/",
                  ...
                  Pv.load(e, n, te, void 0, function () {
                    Hv(r, n.prefix + n.resource + n.suffix, e);
                  })));
          }),
          f.loadQueue(
            function () {
    ...
    X(i)
      ? (N1(i) ||
          ...
          ((t = e.getParam("theme_url"))
            ? Lv.load(i, e.documentBaseURI.toAbsolute(t))
            : Lv.load(i, "themes/" + i + "/theme" + r + ".js")),
  ...
  var B1 = Yn,
    ...
    H1 = function (t, n, r) {
      var o,
        ...
        u,
        e = Pv.get(r),
        s = Pv.urls[r] || t.documentBaseUrl.replace(/\/$/, "");
      if (
        ((r = Et.trim(r)),
        e &&
          -1 === Et.inArray(n, r) &&
          (Et.each(Pv.dependencies(r), function (e) {
            H1(t, n, e);
          }),
          !t.plugins[r]))
      )
    ...
    j1 = Za.DOM,
    V1 = { "font-size": "size", "font-family": "face" },
    q1 = R1("font-size"),
    $1 = i(function (e) {
    ...
    X1 = Et.inArray,
    Y1 =
      ((G1.prototype.execCommand = function (t, n, r, e) {
        var o,
          i,
          a = !1,
          u = this;
        if (!u.editor.removed) {
          ...
          if (
            (W1(this.editor.plugins, function (e) {
      ...
      (G1.prototype.queryCommandState = function (e) {
        var t;
      ...
      (G1.prototype.queryCommandValue = function (e) {
        var t;
        if (!this.editor.quirks.isHidden() && !this.editor.removed) {
      ...
      (G1.prototype.addCommands = function (e, n) {
        void 0 === n && (n = "exec");
        var r = this;
        W1(e, function (t, e) {
          W1(e.toLowerCase().split(","), function (e) {
            r.commands[n][e] = t;
          });
        });
      }),
      (G1.prototype.addCommand = function (e, o, i) {
        var a = this;
        (e = e.toLowerCase()),
      ...
      (G1.prototype.queryCommandSupported = function (e) {
      ...
      (G1.prototype.addQueryStateHandler = function (e, t, n) {
        var r = this;
        (e = e.toLowerCase()),
      ...
      (G1.prototype.addQueryValueHandler = function (e, t, n) {
        var r = this;
        (e = e.toLowerCase()),
      ...
      (G1.prototype.hasCustomCommand = function (e) {
        return (e = e.toLowerCase()), !!this.commands.exec[e];
      }),
      (G1.prototype.execNativeCommand = function (e, t, n) {
        return (
          void 0 === t && (t = !1),
          void 0 === n && (n = null),
      ...
      (G1.prototype.isFormatMatch = function (e) {
        return this.editor.formatter.match(e);
      }),
      (G1.prototype.toggleFormat = function (e, t) {
        this.editor.formatter.toggle(e, t), this.editor.nodeChanged();
      }),
      (G1.prototype.storeSelection = function (e) {
        this.selectionBookmark = this.editor.selection.getBookmark(e);
      }),
      (G1.prototype.restoreSelection = function () {
        this.editor.selection.moveToBookmark(this.selectionBookmark);
      }),
      (G1.prototype.setupCommands = function (u) {
        var o = this;
        function e(r) {
          return function () {
            var e = u.selection,
        ...
        this.addCommands({
          ...
          "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull,JustifyNone":
            function (e) {
              var t = e.substring(7);
              "full" === t && (t = "justify"),
                W1("left,center,right,justify".split(","), function (e) {
          ...
          FontSize: function (e, t, n) {
            var r;
            (r = u).formatter.toggle("fontsize", { value: O1(r, n) }),
              r.nodeChanged();
          },
  ...
  function ex(e, t) {
    ...
    J1(o, "mce-content-readonly", t),
      t
        ...
        : (Z1(o, !(e.readonly = !1)),
          Y(bu(o, "*[" + rx + '="true"]'), function (e) {
            yn(e, rx), Z1(e, !0);
          }),
          Q1(e, "StyleWithCSS", !1),
          Q1(e, "enableInlineTableEditing", !1),
          Q1(e, "enableObjectResizing", !1),
          (yd((n = e)) ||
            ((r = n),
  ...
  function nx(t) {
    t.parser.addAttributeFilter("contenteditable", function (e) {
      tx(t) &&
        Y(e, function (e) {
          e.attr(rx, e.attr("contenteditable")),
            e.attr("contenteditable", "false");
        });
    }),
      t.serializer.addAttributeFilter(rx, function (e) {
        tx(t) &&
          Y(e, function (e) {
            e.attr("contenteditable", e.attr(rx));
          });
      }),
      t.serializer.addTempAttr(rx);
  }
  var rx = "data-mce-contenteditable",
    ox = Et.makeMap(
      "focus blur focusin focusout click dblclick mousedown mouseup mousemove mouseover beforepaste paste cut copy selectionchange mouseout mouseenter mouseleave wheel keydown keypress keyup input beforeinput contextmenu dragstart dragend dragover draggesture dragdrop drop drag submit compositionstart compositionend compositionupdate touchstart touchmove touchend touchcancel",
      " "
    ),
    ix =
      ((ax.isNative = function (e) {
        return !!ox[e.toLowerCase()];
      }),
      (ax.prototype.fire = function (e, t) {
        var n = e.toLowerCase(),
          r = uo(n, t || {}, this.scope);
      ...
      (ax.prototype.on = function (e, t, n, r) {
        if ((t = !1 === t ? D : t)) {
      ...
      (ax.prototype.once = function (e, t, n) {
        return this.on(e, t, n, { once: !0 });
      }),
      (ax.prototype.has = function (e) {
        return (
          (e = e.toLowerCase()),
  ...
  function ux(n) {
    return (
      n._eventDispatcher ||
        (n._eventDispatcher = new ix({
          scope: n,
          toggleEvent: function (e, t) {
            ix.isNative(e) && n.toggleNativeEvent && n.toggleNativeEvent(e, t);
          },
        })),
      n._eventDispatcher
    );
  ...
  function sx(e, t) {
    ...
    var n = Ps(e);
    return n
      ? (e.eventRoot || (e.eventRoot = px.select(n)[0]), e.eventRoot)
      : e.getBody();
  }
  function cx(e, t, n) {
    var r, o, i, a;
              ...
              ((mx[a] = e =
                function (e) {
                  for (
                    ...
                    var o = n[r].getBody();
                    (o !== t && !px.isChildOf(t, o)) || cx(n[r], a, e);
                  }
                }),
              px.bind(t, a, e)))
          : (px.bind(
  ...
  function fx(e, t, n, r) {
    ...
    o.deactivate(),
      o.editorReadOnly !== i.editorReadOnly && ex(e, i.editorReadOnly),
      t.set(r),
  ...
  function dx(e) {
    var t,
      n = {};
    bx(yx(e.toLowerCase(), "+"), function (e) {
      e in xx
        ? (n[e] = !0)
        : /^[0-9]{2,}$/.test(e)
        ? (n.keyCode = parseInt(e, 10))
        : ((n.charCode = e.charCodeAt(0)),
          (n.keyCode = Cx[e] || e.toUpperCase().charCodeAt(0)));
    });
    var r = [n.keyCode];
    for (t in xx) n[t] ? r.push(t) : (n[t] = !1);
    return (
      (n.id = r.join(",")),
  ...
  var mx,
    gx = {
      ...
      on: function (e, t, n) {
        return ux(this).on(e, t, n);
      },
      off: function (e, t) {
        return ux(this).off(e, t);
      },
      once: function (e, t) {
        return ux(this).once(e, t);
      },
      hasEventListeners: function (e) {
        return ux(this).has(e);
      },
    },
    px = Za.DOM,
    hx = _e(_e({}, gx), {
        ...
        "focus" !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized &&
                (n.dom.unbind(sx(n, e), e, n.delegates[e]),
    ...
    xx = Et.makeMap("alt,ctrl,shift,meta,access"),
    wx =
      ((Sx.prototype.add = function (e, n, t, r) {
        var o = this,
          i = o.normalizeCommandFunc(t);
        return (
          bx(yx(Et.trim(e)), function (e) {
      ...
      (Sx.prototype.normalizeCommandFunc = function (e) {
        var t = this,
          n = e;
      ...
      (Sx.prototype.createShortcut = function (e, t, n, r) {
        var o = Et.map(yx(e, ">"), dx);
        return (
      ...
      (Sx.prototype.hasModifier = function (e) {
        return e.altKey || e.ctrlKey || e.metaKey;
      }),
      (Sx.prototype.isFunctionKey = function (e) {
        return "keydown" === e.type && 112 <= e.keyCode && e.keyCode <= 123;
      }),
      (Sx.prototype.matchShortcut = function (e, t) {
        return (
          !!t &&
          t.ctrl === e.ctrlKey &&
          t.meta === e.metaKey &&
      ...
      (Sx.prototype.executeShortcutAction = function (e) {
  ...
  var Ex = Za.DOM,
    ...
    Rx =
      ((Dx.prototype.render = function () {
        !(function (t) {
          ...
          var n,
            ...
            i,
            a = function () {
              j1.unbind(window, "ready", a), t.render();
            };
          si.Event.domLoaded
            ? t.getElement() &&
              xt.contentEditable &&
              ...
              (i = t.getElement().form || j1.getParent(e, "form")) &&
                ((t.formElement = i),
                t.getParam("hidden_input") &&
                  !Hn(t.getElement()) &&
                  (j1.insertAfter(
                    j1.create("input", { type: "hidden", name: e }),
                    e
                  ),
                  (t.hasHiddenInput = !0)),
                ...
                j1.bind(i, "submit reset", t.formEventDelegate),
                t.on("reset", function () {
                  t.resetContent();
                }),
              ...
              (t.windowManager = Iv(t)),
              (t.notificationManager = cv(t)),
              "xml" === t.getParam("encoding") &&
                t.on("GetContent", function (e) {
                  e.save && (e.content = j1.encode(e.content));
                }),
              ...
              A1(t, t.suffix))
            : j1.bind(window, "ready", a);
        })(this);
      }),
      (Dx.prototype.focus = function (e) {
        this.execCommand("mceFocus", !1, e);
      }),
      (Dx.prototype.hasFocus = function () {
        return yd(this);
      }),
      (Dx.prototype.execCallback = function (e) {
        for (var t = [], n = 1; n < arguments.length; n++)
          t[n - 1] = arguments[n];
        var r,
          o = this.settings[e];
      ...
      (Dx.prototype.translate = function (e) {
        return cu.translate(e);
      }),
      (Dx.prototype.getParam = function (e, t, n) {
        return (
          (i = t),
          (a = n),
      ...
      (Dx.prototype.hasPlugin = function (e, t) {
        return !(!T(Ms(this).split(/[ ,]/), e) || (t && void 0 === Pv.get(e)));
      }),
      (Dx.prototype.nodeChanged = function (e) {
        this._nodeChangeDispatcher.nodeChanged(e);
      }),
      (Dx.prototype.addCommand = function (e, t, n) {
        this.editorCommands.addCommand(e, t, n);
      }),
      (Dx.prototype.addQueryStateHandler = function (e, t, n) {
        this.editorCommands.addQueryStateHandler(e, t, n);
      }),
      (Dx.prototype.addQueryValueHandler = function (e, t, n) {
        this.editorCommands.addQueryValueHandler(e, t, n);
      }),
      (Dx.prototype.addShortcut = function (e, t, n, r) {
        this.shortcuts.add(e, t, n, r);
      }),
      (Dx.prototype.execCommand = function (e, t, n, r) {
        return this.editorCommands.execCommand(e, t, n, r);
      }),
      (Dx.prototype.queryCommandState = function (e) {
        return this.editorCommands.queryCommandState(e);
      }),
      (Dx.prototype.queryCommandValue = function (e) {
        return this.editorCommands.queryCommandValue(e);
      }),
      (Dx.prototype.queryCommandSupported = function (e) {
      ...
      (Dx.prototype.show = function () {
        this.hidden &&
          ...
          this.inline
            ...
            : (Ex.show(this.getContainer()), Ex.hide(this.id)),
          this.load(),
          this.fire("show"));
      }),
      (Dx.prototype.hide = function () {
        var e = this,
          t = e.getDoc();
        e.hidden ||
          (Ax && t && !e.inline && t.execCommand("SelectAll"),
          e.save(),
          e.inline
            ? ((e.getBody().contentEditable = "false"),
              e === e.editorManager.focusedEditor &&
                (e.editorManager.focusedEditor = null))
            : (Ex.hide(e.getContainer()),
              Ex.setStyle(e.id, "display", e.orgDisplay)),
          (e.hidden = !0),
          e.fire("hide"));
      }),
      (Dx.prototype.isHidden = function () {
        return !!this.hidden;
      }),
      (Dx.prototype.setProgressState = function (e, t) {
        this.fire("ProgressState", { state: e, time: t });
      }),
      (Dx.prototype.load = function (e) {
          ...
          return (
            ...
            Hn(o)
              ...
              : ((!e.is_removing && r.inline) || (o.innerHTML = t),
                (n = Ex.getParent(r.id, "form")) &&
                  Nx(n.elements, function (e) {
      ...
      (Dx.prototype.setContent = function (e, t) {
        return Jh(this, e, t);
      }),
      (Dx.prototype.getContent = function (e) {
        return (
          (t = this),
          (r = (n = void 0 === (n = e) ? {} : n).format || "html"),
          (o = n),
          vh(t).editor.getContent(o, r)
        );
        var t, n, r, o;
      }),
      (Dx.prototype.insertContent = function (e, t) {
        t && (e = kx({ content: e }, t)),
          this.execCommand("mceInsertContent", !1, e);
      }),
      (Dx.prototype.resetContent = function (e) {
        void 0 === e
          ? Jh(this, this.startContent, { format: "raw" })
          : Jh(this, e),
          this.undoManager.reset(),
          this.setDirty(!1),
          this.nodeChanged();
      }),
      (Dx.prototype.isDirty = function () {
        return !this.isNotDirty;
      }),
      (Dx.prototype.setDirty = function (e) {
        var t = !this.isNotDirty;
        (this.isNotDirty = !e), e && e !== t && this.fire("dirty");
      }),
      (Dx.prototype.getContainer = function () {
        return (
          this.container ||
            (this.container = Ex.get(
              this.editorContainer || this.id + "_parent"
            )),
          this.container
        );
      }),
      (Dx.prototype.getContentAreaContainer = function () {
        return this.contentAreaContainer;
      }),
      (Dx.prototype.getElement = function () {
        return (
          this.targetElm || (this.targetElm = Ex.get(this.id)), this.targetElm
        );
      }),
      (Dx.prototype.getWin = function () {
        var e;
        return (
          this.contentWindow ||
      ...
      (Dx.prototype.getBody = function () {
        var e = this.getDoc();
        return this.bodyElement || (e ? e.body : null);
      }),
      (Dx.prototype.convertURL = function (e, t, n) {
        var r = this.settings;
      ...
      (Dx.prototype.addVisual = function (e) {
        var t;
        (t = e), bh(this).editor.addVisual(t);
      }),
      (Dx.prototype.remove = function () {
        ...
        (e = this).removed ||
          ...
          e.hasHiddenInput && o && bv.remove(o.nextSibling),
          e.fire("remove"),
          e.editorManager.remove(e),
          !e.inline && r && bv.setStyle(e.id, "display", e.orgDisplay),
          e.fire("detach"),
          bv.remove(e.getContainer()),
          Qh(t),
          Qh(n),
          e.destroy());
      }),
      (Dx.prototype.destroy = function (e) {
        var t, n, r, o, i, a, u;
        (n = e),
          (a = (t = this).selection),
          (u = t.dom),
            ...
            (n || t.removed
              ? (n ||
                ...
                (o = (r = t).formElement) &&
                  ...
                  bv.unbind(o, "submit reset", r.formEventDelegate)),
      ...
      (Dx.prototype.uploadImages = function (e) {
        return this.editorUpload.uploadImages(e);
      }),
      (Dx.prototype._scanForImages = function () {
        return this.editorUpload.scanForImages();
      }),
      (Dx.prototype.addButton = function () {
        throw new Error(
  ...
  function Dx(e, t, n) {
    ...
    (this.plugins = {}),
      ...
      (this.settings =
        ...
        (y = _e(_e({}, b), h ? Av : {})),
        !1 !== (C = ov(kv || Nv, kv, y, m, g)).deprecation_warnings && Zh(g, C),
        C)),
      ...
      (this.shortcuts = new wx(this)),
      (this.editorCommands = new Y1(this)),
  ...
  function Ox(e) {
    e !== zx &&
      (e
        ? Xa(window).on("resize scroll", Tx)
        : Xa(window).off("resize scroll", Tx),
      (zx = e));
  }
  function Bx(t) {
    var e = jx;
    ...
    return (
      ...
      qx.activeEditor === t && (qx.activeEditor = 0 < jx.length ? jx[0] : null),
      qx.focusedEditor === t && (qx.focusedEditor = null),
      e.length !== jx.length
    );
  }
  var Px,
    ...
    Hx = [],
    jx = [],
    Vx = "CSS1Compat" !== document.compatMode,
    qx = _e(_e({}, gx), {
      baseURI: null,
      baseURL: null,
      defaultSettings: {},
            ...
            Lx.unbind(window, "ready", t),
              ...
              (o = Xa.unique(
                (function (t) {
                  ...
                  if (t.types)
                    return (
                      Mx(t.types, function (e) {
                        n = n.concat(Lx.select(e.selector));
                      }),
                      n
                    );
                  if (t.selector) return Lx.select(t.selector);
                  ...
                  switch (t.mode) {
                    ...
                    case "specific_textareas":
                      Mx(Lx.select("textarea"), function (e) {
              ...
              r.types
                ? Mx(r.types, function (t) {
                    Et.each(o, function (e) {
                      return (
                        !Lx.is(e, t.selector) || (n(u(e), Fx({}, r, t), e), !1)
                      );
                    });
                  })
                : (Et.each(o, function (e) {
      ...
      add: function (e) {
        ...
        return (
          Hx[e.id] === e ||
            (null === n.get(e.id) &&
              ("length" !== e.id && (Hx[e.id] = e), Hx.push(e), jx.push(e)),
            Ox(!0),
            (n.activeEditor = e),
            ...
            Px ||
              ...
              window.addEventListener("beforeunload", Px))),
          e
        );
      },
      createEditor: function (e, t) {
        return this.add(new Rx(e, t, this));
      },
      remove: function (e) {
        var t,
          n,
        ...
        if (e) {
          if (!X(e))
            return (
              ...
              l(r.get(n.id))
                ? null
                : (Bx(n) && r.fire("RemoveEditor", { editor: n }),
                  0 === jx.length &&
                    window.removeEventListener("beforeunload", Px),
                  n.remove(),
                  Ox(0 < jx.length),
                  n)
            );
          Mx(Lx.select(e), function (e) {
            (n = r.get(e.id)) && r.remove(n);
          });
        } else for (t = jx.length - 1; 0 <= t; t--) r.remove(jx[t]);
      },
      execCommand: function (e, t, n) {
        var r = this.get(n);
        switch (e) {
          case "mceAddEditor":
            return this.get(n) || new Rx(n, this.settings, this).render(), !0;
  ...
  var Xx,
    ...
    tw = {
      inflate: function (e, t, n) {
        return Kx(e.x - t, e.y - n, e.w + 2 * t, e.h + 2 * n);
      },
      relativePosition: $x,
      ...
      intersect: function (e, t) {
        var n = Zx(e.x, t.x),
          r = Zx(e.y, t.y),
          o = Qx(e.x + e.w, t.x + t.w),
          i = Qx(e.y + e.h, t.y + t.h);
        return o - n < 0 || i - r < 0 ? null : Kx(n, r, o - n, i - r);
      },
      ...
      fromClientRect: function (e) {
        return Kx(e.left, e.top, e.width, e.height);
      },
    },
    nw =
      ((Xx = {}),
      (Yx = {}),
      {
        ...
        add: function (e, t) {
          void 0 !== Yx[e] && (Yx[e](t), delete Yx[e]), (Xx[e] = Nr.resolve(t));
        },
      }),
    rw = Et.each,
    ow = Et.extend;
  Wx.extend = Gx = function (n) {
    function r() {
      var e, t, n;
      if (
        !Jx &&
    ...
    return (
      (Jx = !1),
      n.Mixins &&
        (rw(n.Mixins, function (e) {
          for (var t in e) "init" !== t && (n[t] = e[t]);
        }),
        o.Mixins && (n.Mixins = o.Mixins.concat(n.Mixins))),
      n.Methods &&
        rw(n.Methods.split(","), function (e) {
          n[e] = t;
        }),
      n.Properties &&
        rw(n.Properties.split(","), function (e) {
          var t = "_" + e;
          n[e] = function (e) {
      ...
      n.Statics &&
        rw(n.Statics, function (e, t) {
          r[t] = e;
        }),
      n.Defaults && o.Defaults && (n.Defaults = ow({}, o.Defaults, n.Defaults)),
      ne(n, function (e, t) {
        var n, r;
  ...
  var iw,
    ...
    mw = _e(_e({}, gx), {
      send: function (e) {
        ...
        if (
          ...
          (e.async = !1 !== e.async),
          (e.data = e.data || ""),
          mw.fire("beforeInitialize", { settings: e }),
          ...
          (t = mw.fire("beforeSend", { xhr: t, settings: e }).xhr).send(e.data),
          !e.async)
        )
          return r();
        _r.setTimeout(r, 10);
    ...
    gw = Et.extend,
    pw =
      ((hw.sendRPC = function (e) {
        return new hw().send(e);
      }),
      (hw.prototype.send = function (e) {
        var n = e.error,
          r = e.success,
          o = gw(this.settings, e);
        (o.success = function (e, t) {
          (e =
            void 0 === (e = fw.parse(e)) ? { error: "JSON Parse error." } : e)
            .error
  ...
  try {
    var vw,
      bw = "__storage_test__";
    (vw = window.localStorage).setItem(bw, bw), vw.removeItem(bw);
  } catch (e) {
    (iw = {}),
      (aw = []),
      (uw = {
        ...
        setItem: function (e, t) {
          aw.push(e), (iw[e] = String(t));
        },
        key: function (e) {
          return aw[e];
        },
        removeItem: function (t) {
          (aw = aw.filter(function (e) {
            return e === t;
          })),
            delete iw[t];
        },
      ...
      Object.defineProperty(uw, "length", {
        get: function () {
          return aw.length;
        },
        configurable: !1,
  ...
  var yw = {
      ...
      util: {
        ...
        ImageUploader: function (n) {
          ...
          return {
            upload: function (e, t) {
              return r.upload(e, (t = void 0 === t || t) ? Kv(n) : void 0);
            },
          };
        },
      },
...
tinymce.baseURL = "https://cdn.tiny.cloud/1/no-origin/tinymce/5.10.5-131";
